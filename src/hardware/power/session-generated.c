 ...
 *
 * This section contains code for working with the <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link> D-Bus interface in C.
 */
 ...
 *
 * Gets a machine-readable description of the <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link> D-Bus interface.
 *
 ...
 * Session:
 *
 * Abstract interface type for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link>.
 */
 ...
 *
 * Virtual table for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link>.
 */
...
session_default_init (SessionIface *iface)
{
   ...
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-cn-kylinos-session.TransferIntValue">TransferIntValue()</link> D-Bus method.
   *
 ...
 *
 * Asynchronously invokes the <link linkend="gdbus-method-cn-kylinos-session.TransferIntValue">TransferIntValue()</link> D-Bus method on @proxy.
 ...
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-cn-kylinos-session.TransferIntValue">TransferIntValue()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 ...
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-cn-kylinos-session.TransferIntValue">TransferIntValue()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link>. See g_dbus_proxy_new() for more details.
 *
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 ...
 * @error: Return location for error or %NULL
 *
 * Synchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link>. See g_dbus_proxy_new_sync() for more details.
 *
 ...
 *
 * Creates a skeleton object for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-session.top_of_page">cn.kylinos.session</link>.
 *
