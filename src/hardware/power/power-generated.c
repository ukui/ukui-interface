 ...
 *
 * This section contains code for working with the <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link> D-Bus interface in C.
 */
 ...
 *
 * Gets a machine-readable description of the <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link> D-Bus interface.
 *
 ...
 * Power:
 *
 * Abstract interface type for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link>.
 */
 ...
 *
 * Virtual table for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link>.
 */
...
power_default_init (PowerIface *iface)
{
   ...
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-cn-kylinos-power.TransferIntValue">TransferIntValue()</link> D-Bus method.
   *
 ...
 *
 * Asynchronously invokes the <link linkend="gdbus-method-cn-kylinos-power.TransferIntValue">TransferIntValue()</link> D-Bus method on @proxy.
 ...
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-cn-kylinos-power.TransferIntValue">TransferIntValue()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 ...
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-cn-kylinos-power.TransferIntValue">TransferIntValue()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link>. See g_dbus_proxy_new() for more details.
 *
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 ...
 * @error: Return location for error or %NULL
 *
 * Synchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link>. See g_dbus_proxy_new_sync() for more details.
 *
 ...
 * power_skeleton_new:
 *
 * Creates a skeleton object for the D-Bus interface <link linkend="gdbus-interface-cn-kylinos-power.top_of_page">cn.kylinos.power</link>.
 *
